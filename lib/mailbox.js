...
Mailbox.prototype.subscribeChild = function(name, callback){
...
Mailbox.prototype.unsubscribeChild = function(name, callback){

    var path = (this.path ? this.path + this.delimiter + name:name);

    this.client._send("UNSUBSCRIBE "+this.client._escapeString(path), (function(){
        if(typeof callback == "function"){
            if(status == "OK"){
                callback(null);
            } else {
