...
IMAPClient.prototype.subscribeMailbox = function(name, callback){
    this._rootMailbox.subscribeChild(name, callback);
};

IMAPClient.prototype.unsubscribeMailbox = function(name, callback){
    this._rootMailbox.unsubscribeChild(name, callback);
};
